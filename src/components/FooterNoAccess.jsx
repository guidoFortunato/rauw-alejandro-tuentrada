export const FooterNoAccess = () => {
  return (
    <footer className="text-white p-5 absolute bottom-0 mx-auto py-10  w-full   bg-black ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3  pt-5 text-start md:text-center">
        <div className="flex justify-start md:justify-center ">
          ...
          <a
            href="https://facebook.com/tuentrada"
            target="_blank"
            rel="noreferrer"
          >
            <svg
